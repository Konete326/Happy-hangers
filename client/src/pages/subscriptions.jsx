                ...
                <div className="bg-stone-50 dark:bg-stone-700/30 rounded-lg p-4">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      <span className="text-sm font-normal text-stone-700 dark:text-stone-300">
                        Plan
                      </span>
                  ...
                  <div className="space-y-4">
                    <div>
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <span className="text-sm text-stone-900 dark:text-white">
                          {currentSubscription.usage.projects.current} /{" "}
                          {currentSubscription.usage.projects.limit}
                        </span>
                      </div>
                    </div>
                    <div>
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <span className="text-sm text-stone-900 dark:text-white">
                          {currentSubscription.usage.storage.current}GB /{" "}
                          {currentSubscription.usage.storage.limit}GB
                        </span>
                      </div>
                      <Progress
                        value={
                          (currentSubscription.usage.storage.current /
                            currentSubscription.usage.storage.limit) *
                          100
                        }
                        className="h-2"
                      />
